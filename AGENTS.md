...
- Windows connected to one server share queue, preferences, and submission progress. Preserve queue three-way merging and request-ID duplicate protection so concurrent windows cannot overwrite edits or submit the same request twice.
